...
<html lang="en">
  <head>
    ...
    <link href="css/bootstrap.min.css" rel="stylesheet">
      ...
      <script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=removedForSecurityReasons"></script>
      <style>
      ...
      <div class="container-fluid" id="myContainer">
          <div class="row">
              <div class="col-md-6 col-md-offset-3">
                  ...
                  <p class="lead" style="color:	white">Reduce Your Carbon Footprint! Save Money!</p>
                  <p class="bold" style="color:	white">You can save thousands per year by signing up for Ride Share&copy;!
                  </p>
                  <!--Search Form-->
      ...
      <div class="modal" id="helpModal" role="dialog" aria-labelledby="mymodalLabel" aria-hidden="true">
        <div class="modal-dialog">
              ...
              <div class="modal-body">
                  ...
                  <ol>
                    <li>Please <a href="#loginModal" data-toggle="modal">Login</a> or <a href="#signupModal" data-toggle="modal">Sign Up</a> to get started.</li>
                    <li>Check for a destination by entering the departure and destination into the search bars provided.</li>
                    <li>You will be matched with a driver that is travelling along that route.</li>
                    <li>You can also sign up to be a driver and deliver people to their destination for a specified fee agreed upon by the driver and the passenger.</li>

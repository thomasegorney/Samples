...
$message .= "http://cs441rideshare.com/activatenewemail.php?email=" . urlencode($email) . "&newemail=" . urlencode($newemail) . "&key=$activationKey";
if(mail($newemail, 'Email Update for RideShare', $message, 'From:'.'parthkapur2@gmail.com')){

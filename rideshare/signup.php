...
$message .= "http://cs441rideshare.com/activate.php?email=" . urlencode($email) . "&key=$activationKey";
if(mail($email, 'Confirm your Registration', $message, 'From:'.'parthkapur2@gmail.com')){
